...
public class Tree {
    ...
    public Iterator<Node> iterator(String identifier,BindingOperation bindingOperation,ParameterAnalysis param,WsdlOperation operation) {
        return this.iterator(identifier, traversalStrategy,bindingOperation,param,operation);
    }

    public Iterator<Node> iterator(String identifier, TraversalStrategy traversalStrategy,BindingOperation bindingOperation,ParameterAnalysis param,WsdlOperation operation) {
        return traversalStrategy == TraversalStrategy.BREADTH_FIRST ?
                new BreadthFirstTreeIterator(nodes, identifier) :
                new DepthFirstTreeIterator(nodes, identifier,bindingOperation,param,operation);        
    }
}